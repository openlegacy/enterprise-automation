...
base_path="$(pwd)/offline-installation"
...
main() {
  ...
  if [[ -f "$config_file" ]]; then
    ...
    read -e -rp "Enter name and tag of the Keycloak image: " -i "openlegacy/openlegacy-keycloak:26.1.2" KEYCLOAK_IMAGE; export KEYCLOAK_IMAGE
